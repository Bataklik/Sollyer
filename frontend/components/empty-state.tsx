...
export function EmptyState({ onAdd, IsLoggedIn }: EmptyStateProps) {
    return (
        <Empty className="border bg-white/80 py-16">
            <EmptyHeader>
                ...
                <EmptyDescription>
                    Je hebt nog geen sollicitaties toegevoegd. Begin met het
                    bijhouden van je sollicitaties door er een toe te voegen.
                </EmptyDescription>
            </EmptyHeader>
            {IsLoggedIn && (
                <EmptyContent>
